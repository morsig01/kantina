...
export default function Header() {
  ...
  const menuData = useMemo(
    () => ({
      Mandag: {
        ...
        portionSize: "Medium",
        description:
          "Saftig kyllingburger med sprøtt brød og friske grønnsaker.",
      ...
      Tirsdag: {
        ...
        portionSize: "Stor",
        description:
          "Klassisk fish & chips med sprø panering og pommes frites.",
  ...
  const [selectedDay, setSelectedDay] =
    useState<keyof typeof menuData>("Mandag");
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              size="icon"
              className="absolute top-3 right-3 transition-transform active:scale-95 hover:bg-gray-100"
            >
